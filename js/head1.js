...
var scrollFunc = function(e){//当滚动条上下滚动时计算滚动量
	...
	if(e.wheelDelta){
        if (e.wheelDelta > 0) { //当滑轮向上滚动时
				...
				if(num==0){
					document.getElementById("imgContent").style.opacity = 1;
					document.getElementById("imgContent").style.left = 70 + "px";
        ...
        if (e.wheelDelta < 0) { //当滑轮向下滚动时
			...
			document.getElementById("imgContent").style.opacity = 0;
			document.getElementById("imgContent").style.left = -800 + "px";
